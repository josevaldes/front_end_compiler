...
class Expr : public Stmt 
{
  ...
  public:
    ...
    virtual void setExprVal() {}
    virtual Type* getType() {setType(); Assert(ty != NULL); return ty;}
    virtual void setType() {}
    friend std::ostream& operator<< (std::ostream& stream, Expr * expr) {
        return stream << expr->GetPrintNameForNode();
    }
    virtual llvm::Value* getExprVal() 
    {
       if(!flag)
       {
          setExprVal();
...
class ArithmeticExpr : public CompoundExpr 
{
  public:
    ...
    ArithmeticExpr(Operator *op, Expr *rhs) : CompoundExpr(op,rhs) {flag = false;}
...
{
  public:
    RelationalExpr(Expr *lhs, Operator *op, Expr *rhs) : CompoundExpr(lhs,op,rhs) {flag = false;}
...
{
  public:
    EqualityExpr(Expr *lhs, Operator *op, Expr *rhs) : CompoundExpr(lhs,op,rhs) {flag = false;}
...
{
  public:
    AssignExpr(Expr *lhs, Operator *op, Expr *rhs) : CompoundExpr(lhs,op,rhs) {flag = false;}
...
{
  public:
    PostfixExpr(Expr *lhs, Operator *op) : CompoundExpr(lhs,op) {flag = false;}
...
class ArrayAccess : public LValue 
{
  ...
  public:
    ...
    Expr *getSub() {return subscript;}
    void storeArrayElem(llvm::Value* rhs);
};
...
class FieldAccess : public LValue 
{
  ...
  public:
    ...
    void storeVectorElem(llvm::Value* rhs);
};
